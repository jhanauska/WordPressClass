...
<![endif]--> ';
								...
								if( of_get_option('skin_style') == 'hazen' ) {
									...
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');									
									wp_enqueue_style('bred_style', get_template_directory_uri().'/skins/bred.css');	
									...
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');
									wp_enqueue_style('bred_style', get_template_directory_uri().'/skins/rubia.css');	
									...
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');
									wp_enqueue_style('Hazen_color', get_template_directory_uri().'/grngy.css');
								}elseif( of_get_option('skin_style') == 'kopr' ) {
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');
									wp_enqueue_style('Hazen_color', get_template_directory_uri().'/kopr.css');
								}elseif( of_get_option('skin_style') == 'marn' ) {
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');
									wp_enqueue_style('bred_style', get_template_directory_uri().'/skins/marn.css');	
								}elseif( of_get_option('skin_style') == 'gree' ) {
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');
									wp_enqueue_style('bred_style', get_template_directory_uri().'/skins/gree.css');	
								}elseif( of_get_option('skin_style') == 'brwgrn' ) {
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');
									wp_enqueue_style('bred_style', get_template_directory_uri().'/skins/brwgrn.css');	
								}elseif( of_get_option('skin_style') == 'pnkr' ) {
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');
									wp_enqueue_style('bred_style', get_template_directory_uri().'/skins/pnkr.css');	
								}elseif( of_get_option('skin_style') == 'bkrd' ) {
									wp_enqueue_style('Hazen_style', get_template_directory_uri().'/hazen.css');	
									wp_enqueue_style('Hazen_responsive', get_template_directory_uri().'/hazenresponsive.css');
									wp_enqueue_style('bred_style', get_template_directory_uri().'/skins/bkrd.css');	
								}else {
...
function Hazen_add_javascript( ) {
	...
	if( !is_admin() ) {
		...
		wp_enqueue_script('Hazen_respmenu', get_template_directory_uri().'/js/tinynav.min.js', array('jquery') );	
...
/* Wp Title */
function Hazen_wp_title( $title, $sep ) {
	global $page, $paged;
...
add_filter( 'wp_title', 'Hazen_wp_title', 10, 2 );
