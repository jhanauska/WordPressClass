...
<div class="show"><?php if(isset($theme_blogdescription) && $theme_blogdescription=="Enable") {  echo '<small>'; bloginfo('description'); echo '</small>'; } ?> <strong><?php bloginfo('name'); ?></strong>
</div>
