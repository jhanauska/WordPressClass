...
<?php foreach ($comments as $comment) : ?>
	...
	<?php comment_text() ?>
	<cite> <?php edit_comment_link(__('Edit This'), '<strong class="edit">', '</strong>'); ?>  <?php echo get_avatar( $comment, 16 ); ?> <?php comment_type(_c('Comment|noun'), __('Trackback'), __('Pingback')); ?> <?php _e('by'); ?> <?php comment_author_link() ?> &#8212; <?php comment_date() ?> @ <a href="#comment-<?php comment_ID() ?>"><?php comment_time() ?></a></cite>
	</li>
...
<div class="postcomment">
	...
	<p class="allowed-xhtml"><?php printf(__('XHTML: %s'), allowed_tags()); ?></p>
